...
class QuestionPageState extends State<QuestionPage>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: _animateController.isCompleted //continue bar
          ? BottomAppBar(
              child: Container(
                ...
                Expanded(
                  child: Center(
                    child: Container(
                      ...
                      child: Card(
                        child: Column(
                          children: List.generate(exerQuestion.length,
                            (int index) {
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    Divider(
                                      height: index < exerQuestion.length
                                          ? 1.0
                                          : 0.0,
                                    ),
                                  ],
                ...
                Expanded(
                  child: Center(
                    child: Container(
                      ...
                      child: Card(
                        child: Column(
                          children: List.generate(genderQuestion.length,
                            (int index) {
